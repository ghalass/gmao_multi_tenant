...
-- CreateIndex
CREATE UNIQUE INDEX "parc_tenantId_name_key" ON "parc"("tenantId", "name");

-- CreateIndex
CREATE UNIQUE INDEX "typeconsommation_lub_name_key" ON "typeconsommation_lub"("name");

-- CreateIndex
CREATE UNIQUE INDEX "engin_tenantId_name_key" ON "engin"("tenantId", "name");
...
-- CreateIndex
CREATE UNIQUE INDEX "anomalie_tenantId_numeroBacklog_key" ON "anomalie"("tenantId", "numeroBacklog");
...
-- AddForeignKey
ALTER TABLE "parc" ADD CONSTRAINT "parc_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "parc" ADD CONSTRAINT "parc_typeOrganeId_fkey" FOREIGN KEY ("typeOrganeId") REFERENCES "type_organe"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "engin" ADD CONSTRAINT "engin_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "anomalie" ADD CONSTRAINT "anomalie_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "statut_anomalie" ADD CONSTRAINT "statut_anomalie_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "organe" ADD CONSTRAINT "organe_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "mvt_organe" ADD CONSTRAINT "mvt_organe_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "revision_organe" ADD CONSTRAINT "revision_organe_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "type_lubrifiant" ADD CONSTRAINT "type_lubrifiant_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "lubrifiant" ADD CONSTRAINT "lubrifiant_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "saisie_lubrifiant" ADD CONSTRAINT "saisie_lubrifiant_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "objectif" ADD CONSTRAINT "objectif_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
